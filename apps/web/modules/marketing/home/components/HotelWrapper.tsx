...
const hotels = [
  { id: 1, name: "Cozy Pet Stay", location: "Lisbon", lat: 38.7169, lng: -9.1399, price: 89, rating: 4, image: "/images/assets/hotel1.jpg", isPartner: false},
  { id: 2, name: "Luxury Pet Resort", location: "Porto", lat: 41.1496, lng: -8.611, price: 129, rating: 5, image: "/images/assets/hotel2.jpg", isPartner: true },
  { id: 3, name: "Beachside Pet Paradise", location: "Algarve", lat: 37.0176, lng: -7.9304, price: 99, rating: 4, image: "/images/assets/hotel3.jpg", isPartner: false },
  { id: 4, name: "Urban Pet Retreat", location: "Braga", lat: 41.5454, lng: -8.4265, price: 75, rating: 3, image: "/images/assets/hotel4.jpeg", isPartner: false },
];
  ...
  return (
    <div className="container flex flex-col md:flex-row h-[90vh] mt-20 mb-5">
      ...
      >
        ...
        <div className="space-y-4">
          {visibleHotels.length === 0 ? (
            ...
            visibleHotels.map((hotel) => <HotelCard key={hotel.id} {...hotel} />)
          )}
        </div>
      </div>
      ...
      <div className="w-full md:w-2/3 h-full pl-3">
        <HotelsMap hotels={hotels} setVisibleHotels={setVisibleHotels} />
      </div>
    </div>
  );
}