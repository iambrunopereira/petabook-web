...
import { z } from "zod";
import { useUpdateRegionMutation } from "../lib/api";
...
interface EditRegionFormProps {
	defaultValues: RegionFormValues & { uuid: string };
}

export function EditRegionForm({ defaultValues }: EditRegionFormProps) {
	...
	return (
		<div className="mx-auto w-full max-w-md">
			<h1 className="font-extrabold text-2xl">Edit Region</h1>
			<Form {...form}>
